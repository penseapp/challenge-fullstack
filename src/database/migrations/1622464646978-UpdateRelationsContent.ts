...
export class UpdateRelationsContent1622464646978 implements MigrationInterface {
    name = 'UpdateRelationsContent1622464646978'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "temporary_favorites"`);
        await queryRunner.query(`ALTER TABLE "favorites" RENAME TO "temporary_favorites"`);
        await queryRunner.query(`CREATE TABLE "favorites" ("id" varchar PRIMARY KEY NOT NULL, "user_id" varchar NOT NULL, "product_id" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "userId" varchar, "productId" varchar, CONSTRAINT "FK_0c7bba48aac77ad13092685ba5b" FOREIGN KEY ("productId") REFERENCES "products" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_e747534006c6e3c2f09939da60f" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
