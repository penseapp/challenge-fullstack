...
VS Store App é um projeto desenvolvido para ao processo seletivo da PenseAPP. O aplicativo foi desenvolvido utilizando o framework React Native em conjunto com o Expo, utilizando Javascript.  
