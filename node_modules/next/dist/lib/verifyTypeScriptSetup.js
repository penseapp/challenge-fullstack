...
// Next.js' types:
await(0,_writeAppTypeDeclarations.writeAppTypeDeclarations)(dir);if(typeCheckPreflight){const{runTypeCheck}=require('./typescript/runTypeCheck');// Verify the project passes type-checking before we go to webpack phase:
return await runTypeCheck(ts,dir,tsConfigPath);}return true;}catch(err){// These are special errors that should not show a stack trace:
